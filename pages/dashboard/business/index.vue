  ...
  <div class="container">
    ...
    <div class='filters'>
      ...
      <c-select  class='search' mr="5" v-model="stage"  placeholder="Filter by stage">
        ...
        <option value="MVP Stage (Minimum Variable Product)">MVP Stage (Minimum Variable Product)</option>
      ...
      <date-picker v-model="dateRange" range class='search'
